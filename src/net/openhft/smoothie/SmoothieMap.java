...
public class SmoothieMap<K, V> extends AbstractMap<K, V> implements Cloneable, Serializable {
     ...
     * #removeIf(BiPredicate)}, {link KeySet#removeAll(Collection)
     ...
     * @see #keyHashCode(Object)
     */
    protected boolean keysEqual(Object queriedKey, K keyInMap) {
     ...
     */
    protected boolean valuesEqual(Object queriedValue, V valueInMap) {
